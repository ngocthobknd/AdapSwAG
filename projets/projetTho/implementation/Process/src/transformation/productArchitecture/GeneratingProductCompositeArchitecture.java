...
public class GeneratingProductCompositeArchitecture implements ProductGenerationService {
	...
	public GeneratingProductCompositeArchitecture() {
	...
	public static void main(String [] args) {
		new GeneratingProductCompositeArchitecture().createProductModel(readArchitecture(""));
	}
